...
globalkeys = gears.table.join(
  ...
  end, { description = "Mute Audio Output", group = "system" }),
  awful.key({}, "XF86AudioMicMute", function()
    awful.util.spawn(volume_mic_mute, false)
  end, { description = "Mute Audio Input", group = "system" }),
  awful.key({}, "XF86MonBrightnessUp", function()
    awful.util.spawn(brightness_up, false)
  end, { description = "Increase Brightness", group = "system" }),
  awful.key({}, "XF86MonBrightnessDown", function()
    awful.util.spawn(brightness_down, false)
  end, { description = "Decrease Brightness", group = "system" }),

  awful.key({ modkey }, "d", function() awful.util.spawn(menu) end,
  ...
  awful.key({ modkey, "Shift" }, "s", function() awful.util.spawn(screenshot) end,
    { description = "Launch Screenshot Tool", group = "Theo Custom Settings" }),
